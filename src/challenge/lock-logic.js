...
function changeDialValue (index, incrementBy) {
  ...
  let cur = lockState.wheels[index]
  lockState.wheels[index] = cur + incrementBy
  ...
  cur = lockState.wheels
  if (cur[0] === SECRET_COMBO[0] && cur[1] === SECRET_COMBO[1] && cur[2] === SECRET_COMBO[2] && cur[3] === SECRET_COMBO[3]) {
    lockState.locked = false
  }
  if (!lockState.lockState) {
    redirect('minzhi-chen')
  }
}
