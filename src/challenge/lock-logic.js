...
function changeDialValue (index, incrementBy) {
  ...
  lockState.wheels[index] = lockState.wheels[index] == 10 ? 0:lockState.wheels[index]
  lockState.wheels[index] = lockState.wheels[index] == -1 ? 9:lockState.wheels[index]
