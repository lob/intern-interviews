...
function changeDialValue(index, incrementBy) {
  ...
  const total = currentValue + incrementBy;
  lockState.wheels[index] = total % 10; // So it doesn't exceed 10
  ...
  const checkEquality =
    JSON.stringify(SECRET_COMBO) === JSON.stringify(lockState.wheels);
